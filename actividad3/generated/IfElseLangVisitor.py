...
class IfElseLangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by IfElseLangParser#addExpr.
    def visitAddExpr(self, ctx:IfElseLangParser.AddExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by IfElseLangParser#mulExpr.
    def visitMulExpr(self, ctx:IfElseLangParser.MulExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by IfElseLangParser#divExpr.
    def visitDivExpr(self, ctx:IfElseLangParser.DivExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by IfElseLangParser#subExpr.
    def visitSubExpr(self, ctx:IfElseLangParser.SubExprContext):
        return self.visitChildren(ctx)

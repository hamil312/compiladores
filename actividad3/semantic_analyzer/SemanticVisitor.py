...
class SemanticVisitor(IfElseLangVisitor):
    ...
    def visitComparisonExpr(self, ctx:IfElseLangParser.ParenExprContext):
    ...
    def visitArithmeticExpr(self, ctx:IfElseLangParser.NumberExprContext): # ArithmeticExprContext
        left_type = self.visit(ctx.expr(0))
        right_type = self.visit(ctx.expr(1))

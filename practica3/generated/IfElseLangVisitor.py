...
class IfElseLangVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by IfElseLangParser#forStatement.
    def visitForStatement(self, ctx:IfElseLangParser.ForStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by IfElseLangParser#declarationNoSemi.
    def visitDeclarationNoSemi(self, ctx:IfElseLangParser.DeclarationNoSemiContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by IfElseLangParser#assignmentNoSemi.
    def visitAssignmentNoSemi(self, ctx:IfElseLangParser.AssignmentNoSemiContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by IfElseLangParser#switchStatement.
    def visitSwitchStatement(self, ctx:IfElseLangParser.SwitchStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by IfElseLangParser#caseStatement.
    def visitCaseStatement(self, ctx:IfElseLangParser.CaseStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by IfElseLangParser#defaultStatement.
    def visitDefaultStatement(self, ctx:IfElseLangParser.DefaultStatementContext):
        return self.visitChildren(ctx)

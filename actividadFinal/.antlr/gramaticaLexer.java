...
public class gramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"FUNCTION", "RETURN", "VAR", "INT_TYPE", "BOOL_TYPE", "AND", "OR", "NOT", 
			"IF", "ELSE", "WHILE", "PRINT", "TRUE", "FALSE", "ASSIGN", "COLON", "COMMA", 
			"SEMI", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "ADD", "SUB", "MUL", 
			"DIV", "EQ", "NEQ", "LTE", "GTE", "LT", "GT", "ID", "INT", "WS", "LINE_COMMENT", 
			"BLOCK_COMMENT"
		};
	}
